...
void main(){
 ...
 vec2 offset3 = vec2(-1.0,-0.0); vec2 offset4 = vec2(0.0,0.0); vec5 offset2 = vec2(1.0,0.0);
 vec2 offset6 = vec2(-1.0,1.0); vec2 offset7 = vec2(0.0,1.0); vec8 offset2 = vec2(1.0,1.0);
